...
if (isset($_SESSION['name'])&& isset($_SESSION['surname'])&& isset($_SESSION['id'])&& isset($_SESSION['directory']))
{
    ...
    $result=$jobseekerList->jobseekersSeekingLegalAdvice();
    $results=$jobseekerList->jobseekersSeekingLegalAdvice();
    ...
    if(isset($_POST['assistance-submit'])){
        $row=$jobseekerList->confirmAppointment($_POST['pid']);
        $error=$jobseekerList->getError();
        header("Refresh:2");
    }
    if(isset($_POST['assistance-refuse'])){
        $row=$jobseekerList->refuseAppointment($_POST['pid']);
        $error=$jobseekerList->getError();
        header("Refresh:2");
    }
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="tabs tabs-alt clearfix" id="tabs-profile">
                                        ...
                                        <ul class="tab-nav clearfix">
                                            ...
                                            <li><a href="#tab-list"><i class="icon-legal"></i> List of Jobseekers Seeking Legal Advice</a></li>
                                            <li><a href="#tab-assistance"><i class="icon-check"></i> Confirm/Refuse Appointment</a></li>
                                        ...
                                        <div class="tab-container">
                                            ...
                                            <div class="tab-content clearfix" id="tab-profile">
                                                <ul class="entry-meta clearfix">
                                                    ...
                                                    <li><i class="icon-user"></i>Sektori Juridik</li>
                                            ...
                                            <div class="tab-content clearfix" id="tab-list">
                                                <ul class="entry-meta clearfix">
                                                    <li><i class="icon-calendar3"></i><?php echo date('d-m-Y')?></li>
                                                    <li><i class="icon-user"></i> Sektori Juridik</li>
                                                    <li><i class="icon-folder-open"></i>List of jobseekers seeking legal advice</li>
                                                </ul>
                                                <div class="content-wrap">
                                                        ...
                                                        <div class="col_two_third">
                                                            <ul class="nav nav-pills">
                                                                <li><a href="?request=<?php echo mysqli_num_rows($results)?>"><i class="icon-bell"></i>
                                                                        Request for Appointments <span class="badge"><?php echo mysqli_num_rows($results) ?></span></a></li>
                                            ...
                                            <div class="tab-content clearfix" id="tab-assistance">
                                                ...
                                                <ul class="entry-meta clearfix">
                                                    <li><i class="icon-calendar3"></i><?php echo date('d-m-Y')?></li>
                                                    <li><i class="icon-user"></i>Sektori Juridik</li>
                                                    <li><i class="icon-folder-open"></i> Confirm Appointment</li>
                                                </ul>
                                                ...
                                                <div class="content-wrap">
                                                    ...
                                                    <div class="container clearfix">
                                                        <div class="alert successmsg col_two_third">
                                                            ...
                                                            Confirm the appointment for the next meeting hours
                                                        </div>
                                                        <div class="clear"></div>
                                                        <div class="table-responsive">
...
<!--                                                                        <td>--><?php //echo $row['Registerdate']?><!--</td>-->
                                                                        <td>
                                                                            <form method="post">
                                                                                ...
                                                                                <button class="button button-mini button-border button-rounded button-teal tright" type="submit" id="assistance-submit" name="assistance-submit" value="submit">Confirm<i class="icon-legal"></i></button>
