...
require_once("classes/trainings.php");
...
if (isset($_SESSION['name'])&& isset($_SESSION['surname'])&& isset($_SESSION['id'])&& isset($_SESSION['directory']))
{
    ...
    $trainingList=new crud_trainings();
    $result=$content->read();
    $results=$trainingList->read();

    if(isset($_POST['delete'])){
        $trainingList->delete($_POST['pid']);
        $error=$trainingList->getError();
        header("Refresh:2");
    }
    ...
    if(isset($_POST['register-form-submit'])) {
        $title=$_POST['register-form-title'];
        $start=$_POST['register-form-start'];
        $end=$_POST['register-form-end'];
        $description=$_POST['register-form-description'];
        $places=$_POST['register-form-places'];

        $training=new trainings($title,$description,$start,$end,$places);
        $CRUD=new crud_trainings();
        $CRUD->create($training);
        $error=$CRUD->getError();
    }
    ?>
    <!DOCTYPE html>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="tabs tabs-alt clearfix" id="tabs-profile">
                                        ...
                                        <ul class="tab-nav clearfix">
                                            ...
                                            <li><a href="#tab-list"><i class="icon-users"></i> List of all trainings</a></li>
                                            <li><a href="#tab-new"><i class="icon-plus"></i> New training</a></li>
                                            <li><a href="#tab-delete"><i class="icon-remove-sign"></i>Delete trainings</a></li>
                                        ...
                                        <div class="tab-container">
                                            ...
                                            <div class="tab-content clearfix" id="tab-profile">
                                                <ul class="entry-meta clearfix">
                                                    ...
                                                    <li><i class="icon-user"></i> Drejtoria e Programeve dhe Integrimit ne Tregun e Punes</li>
                                            ...
                                            <div class="tab-content clearfix" id="tab-list">
                                                <ul class="entry-meta clearfix">
                                                    <li><i class="icon-calendar3"></i><?php echo date('d-m-Y')?></li>
                                                    <li><i class="icon-user"></i> Drejtoria e Programeve dhe Integrimit ne Tregun e Punes</li>
                                                    <li><i class="icon-folder-open"></i>List of all trainings</li>
                                                </ul>
                                                <div class="content-wrap">
                                            ...
                                            <div class="tab-content clearfix" id="tab-new">
                                                <ul class="entry-meta clearfix">
                                                    <li><i class="icon-calendar3"></i><?php echo date('d-m-Y')?></li>
                                                    <li><i class="icon-user"></i>Drejtoria e Programeve dhe Integrimit ne Tregun e Punes</li>
                                                    <li><i class="icon-folder-open"></i> New training</li>
                                                </ul>
                                                    ...
                                                    <div class="">
                                                        ...
                                                        <form action="#" method="post">
                                                            ...
                                                            <div class="col_two_third">
                                                                <label for="register-form-title">Title <small>*</small></label>
                                                                <input type="text" id="register-form-title" name="register-form-title" value="" class="sm-form-control required" />
                                                            </div>


                                                            <div class="col_one_third col_last">
                                                                <label for="register-form-places">Places</label>
                                                                <input type="number" id="register-form-places" min="5" name="register-form-places" value="" class="sm-form-control" />
                                                            </div>

                                                            <div class="clear"></div>

                                                            <div class="col_two_third">
                                                                <label for="register-form-start">Start Date <small>*</small></label>
                                                                <input type="date" id="contactform-start" name="register-form-start" value="" class="sm-form-control required" />
                                                            </div>

                                                            <div class="col_one_third col_last">
                                                                <label for="register-form-end">End Date <small>*</small></label>
                                                                <input type="date" id="register-form-end" name="register-form-end" value="" class="required sm-form-control" />

                                                            </div>


                                                            <div class="clear"></div>
                                                            <label for="register-form-description">Description <small>*</small></label>
                                                            <textarea id="register-form-description" name="register-form-description" cols="80" rows="10"></textarea>
                                                            <div class="clear"></div>
                                                            <div class="col_full">
                                            ...
                                            <div class="tab-content clearfix" id="tab-delete">
                                                ...
                                                <ul class="entry-meta clearfix">
                                                    <li><i class="icon-calendar3"></i><?php echo date('d-m-Y')?></li>
                                                    <li><i class="icon-user"></i> Drejtoria e Programeve dhe Integrimit ne Tregun e Punes</li>
                                                    <li><i class="icon-folder-open"></i> Delete Trainings</li>
                                                </ul>
